...
class HorseSpider(scrapy.Spider):
    ...
    def parse_results(self, response):
        ...
        try:
            ...
            log.msg('winoddsranks: {}'.format(str(winoddsranks)), level=log.INFO)
            log.msg('winodds_float: {}'.format(winodds_float), level=log.INFO)
            log.msg('horsecode: {}'.format(response.meta['horsecode']), level=log.INFO)
